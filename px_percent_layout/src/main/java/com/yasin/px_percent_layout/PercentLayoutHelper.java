...
import com.yasin.px_percent_layout.utils.ViewUtils;
...
public class PercentLayoutHelper {
    ...
    private static ViewGroup mHost;
    ...
    private void supportPadding(int widthHint, int heightHint, View view, PercentLayoutInfo info) {
        ...
        if (percentVal != null) {
            ...
            if (percentVal.basemode == PercentLayoutInfo.BASEMODE.ABSOLUTE_PX) {
                left = ViewUtils.scaleValue(mHost.getContext(), percentVal.percent);
            } else {
        ...
        if (percentVal != null) {
            int base = getBaseByModeAndVal(widthHint, heightHint, percentVal.basemode);
            if (percentVal.basemode == PercentLayoutInfo.BASEMODE.ABSOLUTE_PX) {
                right = ViewUtils.scaleValue(mHost.getContext(), percentVal.percent);
            } else {
        ...
        if (percentVal != null) {
            int base = getBaseByModeAndVal(widthHint, heightHint, percentVal.basemode);
            if (percentVal.basemode == PercentLayoutInfo.BASEMODE.ABSOLUTE_PX) {
                top = ViewUtils.scaleValue(mHost.getContext(), percentVal.percent);
            } else {
        ...
        if (percentVal != null) {
            int base = getBaseByModeAndVal(widthHint, heightHint, percentVal.basemode);
            if (percentVal.basemode == PercentLayoutInfo.BASEMODE.ABSOLUTE_PX) {
                bottom = ViewUtils.scaleValue(mHost.getContext(), percentVal.percent);
            } else {
    ...
    private void invokeMethod(String methodName, int widthHint, int heightHint, View view, Class clazz, PercentLayoutInfo.PercentVal percentVal) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        ...
        if (percentVal != null) {
            ...
            int base = getBaseByModeAndVal(widthHint, heightHint, percentVal.basemode);
            if (percentVal.basemode == PercentLayoutInfo.BASEMODE.ABSOLUTE_PX) {
                setMaxWidthMethod.invoke(view, ViewUtils.scaleValue(mHost.getContext(), percentVal.percent));
            } else {
    ...
    public static class PercentLayoutInfo {
        ...
        public void fillLayoutParams(ViewGroup.LayoutParams params, int widthHint,
            ...
            if (widthPercent != null) {
                ...
                if (widthPercent.basemode == BASEMODE.ABSOLUTE_PX) {
                    params.width = ViewUtils.scaleValue(mHost.getContext(), widthPercent.percent);
                } else {
            ...
            if (heightPercent != null) {
                ...
                if (heightPercent.basemode == BASEMODE.ABSOLUTE_PX) {
                    params.height = ViewUtils.scaleValue(mHost.getContext(),heightPercent.percent);
                } else {
        ...
        public void fillMarginLayoutParams(ViewGroup.MarginLayoutParams params, int widthHint,
            ...
            if (leftMarginPercent != null) {
                ...
                if(leftMarginPercent.basemode==BASEMODE.ABSOLUTE_PX){
                    params.leftMargin=ViewUtils.scaleValue(mHost.getContext(),leftMarginPercent.percent);
                }else{
            ...
            if (topMarginPercent != null) {
                ...
                if(topMarginPercent.basemode==BASEMODE.ABSOLUTE_PX){
                    params.topMargin=ViewUtils.scaleValue(mHost.getContext(),topMarginPercent.percent);
                }else{
            ...
            if (rightMarginPercent != null) {
                ...
                if(rightMarginPercent.basemode==BASEMODE.ABSOLUTE_PX){
                    params.rightMargin=ViewUtils.scaleValue(mHost.getContext(),rightMarginPercent.percent);
                }else{
            ...
            if (bottomMarginPercent != null) {
                ...
                if(bottomMarginPercent.basemode==BASEMODE.ABSOLUTE_PX){
                    params.bottomMargin=ViewUtils.scaleValue(mHost.getContext(),bottomMarginPercent.percent);
                }else{
            ...
            if (startMarginPercent != null) {
                ...
                if(startMarginPercent.basemode==BASEMODE.ABSOLUTE_PX){
                    MarginLayoutParamsCompat.setMarginStart(params,
                            ViewUtils.scaleValue(mHost.getContext(),startMarginPercent.percent));
                }else{
                    MarginLayoutParamsCompat.setMarginStart(params,
            ...
            if (endMarginPercent != null) {
                ...
                if(endMarginPercent.basemode==BASEMODE.ABSOLUTE_PX){
                    MarginLayoutParamsCompat.setMarginEnd(params,
                            ViewUtils.scaleValue(mHost.getContext(),endMarginPercent.percent));
                }else{
                    MarginLayoutParamsCompat.setMarginEnd(params,
